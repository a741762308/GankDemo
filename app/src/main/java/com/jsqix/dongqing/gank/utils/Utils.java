...
public class Utils
{
    ...
    public static String getCachePath()
    {
        if (Utils.sdcardMounted())
        {
            return Environment.getExternalStorageDirectory().getPath() + "/Android/data/"
                    + MyApp.getInstance().getPackageName() + "/cache/";
        }
        else
        {
            return MyApp.getInstance().getFilesDir().getPath() + "data/"
                    + MyApp.getInstance().getPackageName() + "/cache/";
        }
    }
    ...
    {
        ConnectivityManager cm = (ConnectivityManager) MyApp.getInstance().getSystemService(
