...
import com.jsqix.dongqing.gank.BuildConfig;
...
public class LogWriter {
    private static final String DEBUG_TAG = "Gank";
    ...
    public static void LogToFile(final String tag, final String text) {
        ...
        final String filePath = Environment.getExternalStorageDirectory().getPath() + "/" + MyApp.getInstance().getPackageName();
